...
/****************************************************************************************************************************/
  ...
  /****************************************************************************************************************************/
        ...
        if (this.currentTrend === 'long' ) {
            ...
            if( percentBollinger10 > 1 && price > myFrontAppIndicator.EMA10 ){
              sellAction(this);
            }
            ...
            this.triggerSell = 0
             ...
             // #1
             if ( price > myFrontAppIndicator.EMA10 &&  price > myFrontAppIndicator.EMA20 && percentBollinger10 < 0.8 && this.percentBetweenPriceAndMa <40  || myFrontAppIndicator.EMA10 <  myFrontAppIndicator.SMA20){
